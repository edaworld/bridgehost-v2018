...
#define oLED_DC_LOW()     GPIO_ResetBits(GPIOB, GPIO_Pin_7)
#define oLED_DC_HIGH()    GPIO_SetBits(GPIOB, GPIO_Pin_7)
...
{
	"汇睿微通科技温湿度发送接收无线模块应答成功失败系统初始化错误有单次连续切换模式非为到"
...
{
// 汇(0) 睿(1) 微(2) 通(3) 科(4) 技(5) 温(6) 湿(7) 度(8) 发(9) 送(10) 接(11) 收(12)
	0x00, 0x20, 0x44, 0xCC, 0x20, 0x00, 0xF8, 0x08, 0x08, 0x08, 0x08, 0x08, 0x04, 0x00, 0x00, 0x08, 0x7E, 0x01, 0x00, 0x00, 0x3F, 0x40, 0x40, 0x40, 0x40, 0x40, 0x20, 0x00, /*"汇",0*/
	0x00, 0x00, 0x38, 0x90, 0x70, 0xB0, 0x6E, 0xB6, 0xB4, 0x74, 0xB4, 0x9C, 0x00, 0x00, 0x00, 0x04, 0x05, 0x02, 0x7F, 0x6A, 0x6A, 0x6A, 0x6A, 0x7F, 0x02, 0x02, 0x02, 0x00, /*"睿",1*/
	0x00, 0x08, 0xC4, 0x24, 0xB8, 0xA8, 0xBE, 0xB8, 0xC0, 0xF8, 0x26, 0xE0, 0x10, 0x00, 0x00, 0x01, 0x7F, 0x00, 0x30, 0x0E, 0x82, 0x5E, 0x49, 0x23, 0x1C, 0x27, 0x40, 0x00, /*"微",2*/
	0x00, 0x40, 0xCC, 0x40, 0x00, 0xF0, 0xA4, 0xA4, 0xFC, 0xA4, 0xA4, 0xF0, 0x00, 0x00, 0x00, 0x20, 0x1F, 0x10, 0x20, 0x5F, 0x42, 0x42, 0x5F, 0x42, 0x42, 0x5F, 0x40, 0x00, /*"通",3*/
	0x00, 0x00, 0x48, 0xFC, 0x44, 0x42, 0x00, 0x88, 0x10, 0x00, 0xFE, 0x02, 0x00, 0x00, 0x00, 0x0C, 0x02, 0x7F, 0x01, 0x03, 0x08, 0x08, 0x05, 0x04, 0xFF, 0x04, 0x02, 0x00, /*"科",4*/
	0x00, 0x10, 0x10, 0xFE, 0x10, 0x90, 0x90, 0x90, 0x90, 0xFE, 0x90, 0x90, 0x10, 0x00, 0x00, 0x02, 0x41, 0x7F, 0x81, 0x80, 0x40, 0x27, 0x28, 0x18, 0x26, 0x41, 0x40, 0x00, /*"技",5*/
	0x00, 0x20, 0x04, 0xF8, 0x10, 0xFC, 0x94, 0x94, 0x94, 0x94, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7E, 0x41, 0x7E, 0x42, 0x7E, 0x42, 0x42, 0x7E, 0x42, 0x7E, 0x40, 0x00, /*"温",6*/
	0x00, 0x20, 0x44, 0xE0, 0x10, 0xFC, 0x94, 0x94, 0x94, 0x94, 0x94, 0xFC, 0x00, 0x00, 0x00, 0x24, 0x7F, 0x40, 0x42, 0x5C, 0x40, 0x7F, 0x40, 0x7F, 0x48, 0x45, 0x42, 0x00, /*"湿",7*/
	0x00, 0x00, 0xF8, 0x48, 0x48, 0xE8, 0x58, 0x46, 0x48, 0xF8, 0x48, 0x28, 0x00, 0x00, 0x40, 0x38, 0x87, 0x80, 0x80, 0x44, 0x4D, 0x35, 0x35, 0x4D, 0x42, 0x40, 0x40, 0x00, /*"度",8*/
	0x00, 0x00, 0x18, 0x24, 0xA0, 0x7C, 0x22, 0x20, 0x22, 0x24, 0xAC, 0x20, 0x00, 0x00, 0x00, 0x40, 0x30, 0x8C, 0x83, 0x41, 0x27, 0x19, 0x19, 0x27, 0x61, 0x40, 0x40, 0x00, /*"发",9*/
	0x40, 0x40, 0xC4, 0x48, 0x80, 0x80, 0xA4, 0xA8, 0xF0, 0xA8, 0xA6, 0x90, 0x80, 0x00, 0x00, 0x20, 0x1F, 0x10, 0x20, 0x30, 0x48, 0x46, 0x43, 0x44, 0x44, 0x58, 0x00, 0x00, /*"送",10*/
	0x00, 0x10, 0x10, 0xFE, 0x90, 0x90, 0x98, 0xA8, 0x8E, 0x68, 0x98, 0x88, 0x48, 0x00, 0x00, 0x02, 0x42, 0x3F, 0x82, 0x82, 0x4E, 0x53, 0x32, 0x1A, 0x26, 0x62, 0x42, 0x00, /*"接",11*/
	0x00, 0xF0, 0x00, 0x00, 0xFE, 0x80, 0x70, 0xEE, 0x22, 0x20, 0xE0, 0x20, 0x10, 0x00, 0x00, 0x0F, 0x04, 0x04, 0x7F, 0x80, 0x40, 0x23, 0x14, 0x1C, 0x23, 0x60, 0x40, 0x00, /*"收",12*/
// 无(0) 线(1) 模(2) 块(3) 应(4) 答(5) 成(6) 功(7) 失(8) 败(9) 系(10) 统(11) 初(12) 始(13) 化(14) 错(15) 误(16) 有(17)
	0x00, 0x00, 0x84, 0x84, 0x84, 0x84, 0xFC, 0x84, 0x84, 0x84, 0x84, 0x44, 0x40, 0x00, 0x00, 0x80, 0x40, 0x20, 0x10, 0x0E, 0x01, 0x3F, 0x40, 0x40, 0x40, 0x40, 0x78, 0x00, /*"无",0*/
	0x00, 0x60, 0x58, 0xC6, 0x60, 0x30, 0x20, 0x2C, 0xF2, 0x24, 0x2C, 0x90, 0x80, 0x00, 0x00, 0x24, 0x27, 0x24, 0x14, 0x43, 0x41, 0x21, 0x1F, 0x19, 0x25, 0x42, 0x70, 0x00, /*"线",1*/
	0x00, 0x00, 0xE0, 0xFE, 0x98, 0x28, 0xE8, 0xBE, 0xA8, 0xA8, 0xBE, 0xE8, 0x00, 0x00, 0x0C, 0x03, 0x00, 0x7F, 0x88, 0x88, 0x4B, 0x2A, 0x1E, 0x1A, 0x2A, 0x4F, 0x48, 0x00, /*"模",2*/
	0x00, 0x00, 0x40, 0xFE, 0x20, 0x10, 0x10, 0xFC, 0x12, 0x10, 0xF0, 0x10, 0x00, 0x00, 0x00, 0x10, 0x10, 0x8F, 0x4A, 0x22, 0x12, 0x0F, 0x06, 0x0A, 0x31, 0x62, 0x41, 0x00, /*"块",3*/
	0x00, 0x00, 0xF8, 0x08, 0x88, 0x08, 0x48, 0x8E, 0x08, 0x08, 0x08, 0xC8, 0x08, 0x00, 0x00, 0x30, 0x0F, 0x00, 0x40, 0x47, 0x40, 0x40, 0x27, 0x58, 0x47, 0x20, 0x20, 0x00, /*"应",4*/
	0x00, 0x20, 0x10, 0x0E, 0xB8, 0x48, 0x28, 0x58, 0x8E, 0x88, 0x38, 0x08, 0x08, 0x00, 0x00, 0x02, 0x02, 0x79, 0x4A, 0x4A, 0x4A, 0x4A, 0x49, 0x7A, 0x09, 0x01, 0x03, 0x00, /*"答",5*/
	0x00, 0x08, 0x08, 0x88, 0xE8, 0x58, 0x4E, 0x48, 0x48, 0x48, 0xC8, 0x08, 0x08, 0x00, 0x00, 0x02, 0x01, 0x00, 0x7F, 0x0A, 0x0A, 0x0A, 0x4A, 0xCA, 0x7F, 0x00, 0x00, 0x00, /*"有",17*/
// 单(0) 次(1) 连(2) 续(3) 切(4) 换(5) 模(6) 式(7) 非(8)  为(9) 到
	0x00, 0x00, 0x00, 0xF0, 0x92, 0x9C, 0xF0, 0x98, 0x94, 0x92, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x08, 0x0C, 0x0B, 0x0A, 0x0A, 0xFF, 0x0A, 0x0A, 0x0A, 0x0B, 0x08, 0x08, 0x00, /*"单",0*/
	0x00, 0x00, 0x04, 0xF8, 0x10, 0xC0, 0x30, 0x2E, 0xE0, 0x20, 0x20, 0x20, 0x10, 0x00, 0x00, 0x00, 0x3F, 0x80, 0x41, 0x20, 0x10, 0x0E, 0x01, 0x0E, 0x10, 0x60, 0x40, 0x00, /*"次",1*/
	0x00, 0x40, 0x4C, 0xC0, 0x08, 0x88, 0xF8, 0x8C, 0xEA, 0xA8, 0x88, 0x88, 0x08, 0x00, 0x00, 0x20, 0x10, 0x1F, 0x24, 0x24, 0x44, 0x44, 0x7F, 0x44, 0x44, 0x44, 0x02, 0x00, /*"连",2*/
	0x00, 0x60, 0x58, 0xC4, 0x30, 0x20, 0x28, 0xA8, 0x7E, 0xAA, 0x28, 0x68, 0x20, 0x00, 0x00, 0x24, 0x27, 0x24, 0xA4, 0x81, 0x4A, 0x28, 0x1F, 0x18, 0x28, 0x68, 0x04, 0x00, /*"续",3*/
	0x00, 0x40, 0x40, 0xFC, 0x40, 0x38, 0x28, 0x08, 0xF8, 0x08, 0x08, 0xE8, 0x18, 0x00, 0x00, 0x00, 0x00, 0x1F, 0x48, 0x44, 0x34, 0x0C, 0x03, 0x00, 0x40, 0x7F, 0x00, 0x00, /*"切",4*/
	0x00, 0x10, 0x10, 0xFE, 0xD0, 0x20, 0xD8, 0x46, 0xE8, 0x58, 0x48, 0xE0, 0x00, 0x00, 0x00, 0x02, 0x41, 0x7F, 0x84, 0x44, 0x23, 0x1C, 0x07, 0x1C, 0x24, 0x63, 0x42, 0x00, /*"换",5*/
	0x00, 0x00, 0xE0, 0xFE, 0x98, 0x28, 0xE8, 0xBE, 0xA8, 0xA8, 0xBE, 0xE8, 0x00, 0x00, 0x0C, 0x03, 0x00, 0x7F, 0x88, 0x88, 0x4B, 0x2A, 0x1E, 0x1A, 0x2A, 0x4F, 0x48, 0x00, /*"模",6*/
	0x00, 0x00, 0x20, 0x20, 0x20, 0x20, 0xA0, 0x2C, 0xF2, 0x20, 0x24, 0x18, 0x10, 0x00, 0x00, 0x60, 0x21, 0x21, 0x1F, 0x11, 0x10, 0x01, 0x07, 0x18, 0x20, 0x40, 0x70, 0x00, /*"式",7*/
	0x00, 0x10, 0x10, 0x10, 0x10, 0xFE, 0x00, 0x00, 0xFE, 0x10, 0x10, 0x90, 0x10, 0x00, 0x00, 0x08, 0x08, 0x09, 0x09, 0x7F, 0x00, 0x00, 0x7F, 0x09, 0x09, 0x08, 0x0C, 0x00, /*"非",8*/
	0x00, 0x00, 0x40, 0x44, 0x58, 0x40, 0xF8, 0x46, 0x40, 0x40, 0x40, 0x40, 0xE0, 0x00, 0x00, 0x40, 0x40, 0x30, 0x08, 0x06, 0x01, 0x01, 0x02, 0x46, 0x40, 0x7C, 0x03, 0x00, /*"为",0*/
	0x00, 0x04, 0x64, 0x54, 0xCC, 0x44, 0x64, 0xC4, 0x00, 0xF8, 0x00, 0x00, 0xFE, 0x00, 0x00, 0x40, 0x44, 0x24, 0x3F, 0x24, 0x24, 0x22, 0x00, 0x0F, 0x40, 0xC0, 0x3F, 0x00, /*"到",0*/
};
...
void MAIN_TIME_Delay(uint16_t usTime);
...
/*****************************************************************************
 ...
 返 回 值  : NONE
*****************************************************************************/
void OLED_P6x8Str(uint8_t ucIdxX, uint8_t ucIdxY, int8_t ucDataStr[])
{
...
/*****************************************************************************
 ...
 返 回 值  : NONE
*****************************************************************************/
void OLED_P8x16Str(uint8_t ucIdxX, uint8_t ucIdxY, int8_t ucDataStr[])
{
	uint8_t i, j, ucDataTmp;
...
/*****************************************************************************
 ...
 输入参数  : uint8_t ucIdxX       为显示的横坐标0~114
			 uint8_t ucIdxY       为页范围0～3
			 uint8_t ucDataStr[]  要显示的中文字符串
 输出参数  : NONE
 返 回 值  : NONE
*****************************************************************************/
void OLED_P14x16Str(uint8_t ucIdxX, uint8_t ucIdxY, int8_t ucDataStr[])
{
	uint8_t i, j;
	uint16_t usAddress;
...
/*****************************************************************************
 ...
 返 回 值  : NONE
*****************************************************************************/
void OLED_PXx16MixStr(uint8_t ucIdxX, uint8_t ucIdxY, int8_t ucDataStr[])
{
	int8_t ucTmpStr[3];
	uint8_t i = 0;
...
/*****************************************************************************
 ...
 返 回 值  : none
*****************************************************************************/
void OLED_PrintChar(uint8_t ucIdxX, uint8_t ucIdxY, int8_t cData)
{
...
/*****************************************************************************
 ...
 返 回 值  : none
*****************************************************************************/
void OLED_PrintShort(uint8_t ucIdxX, uint8_t ucIdxY, int16_t sData)
{
...
void OLED_PrintImage(uint8_t *pucTable, uint16_t usRowNum, uint16_t usColumnNum)
{
	...
	OLED_SetPos(0, (uint8_t)i); //设置剩下的行显示的起始坐标
	usRowTmp = i << 3;       //计算当前所在行的下标
	for (j = 0; j < usColumnNum; j++) //列扫描
	{
		ucData = 0;
...
void MAIN_TIME_Delay(uint16_t usTime)
{
	...
	for (i = (uint64_t)10 * usTime; i > 0; i--)
	{
		for (j = 110; j > 0; j--)
		{
			;
...
/*****************************************************************************
 函 数 名  : OLEDPrint
 功能描述  : 在OLED上面输出信息
 输入参数  : x：介于0和3之间，y:介于0和16之间 
 输出参数  : NONE
 返 回 值  : 
*****************************************************************************/
void OLEDPrint(int x,int y,char *msg) /* 如果要显示中文，OLED点阵字库必须有相应数据，英文则不需要 */
{

    if(y < 0 || y >3)
    {
        OLED_PXx16MixStr(0, 0, (int8_t *)"row is error!");
        return;
    }
    if(x < 0 || y >16)
    {
        OLED_PXx16MixStr(0, 0, (int8_t *)"column is error!"); 
        return;
    }    
    OLED_PXx16MixStr(x, y, (int8_t *)msg);   /* 16个字母 */
//	char buf[8];    
//	sprintf(buf, "%d:", ++count % 10);
//	OLED_PXx16MixStr(0, 3, buf);    //x,横坐标,y,纵坐标
}
